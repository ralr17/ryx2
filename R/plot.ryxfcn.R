...
#' It contains the correlation, p-values, and level of significance between the selected variable and
#' specified variables in the selected dataset. If none are specified, the selected variable will be
#' compared to all other numeric variables in the dataset, excluding itself.
#' @returns The function returns a visualization of the correlations between
